...
''' Q - Write a program that accepts a comma separated sequence of words as input and prints the words in a comma-
...
u_input = input("Please enter comma separated input:")
